                        ...
                        <li class="carousel__slider">
                            <div class="carousel-left">
                                ...
                                <div class="carousel-left-bottom">
                                    ...
                                    <p class="cloud">${cloudsArr[1] + '%' + ' ' + 'Cloudy'}</p>
                        ...
                        <li class="carousel__slider">
                            <div class="carousel-left">
                                ...
                                <div class="carousel-left-bottom">
                                    ...
                                    <p class="cloud">${cloudsArr[2] + '%' + ' ' + 'Cloudy'}</p>
                        ...
                        <li class="carousel__slider">
                            <div class="carousel-left">
                                ...
                                <div class="carousel-left-bottom">
                                    ...
                                    <p class="cloud">${cloudsArr[3] + '%' + ' ' + 'Cloudy'}</p>
                        ...
                        <li class="carousel__slider">
                            <div class="carousel-left">
                                ...
                                <div class="carousel-left-bottom">
                                    ...
                                    <p class="cloud">${cloudsArr[4] + '%' + ' ' + 'Cloudy'}</p>
